        ...
        <>
          <Grid container>
            ...
            >
              ...
              <Item padding={0} margin={0} justifyContent={'center'} alignItems={'center'}>
                <Button height='20px' padding={0} margin={0} fullWidth variant='outlined' color="primary" border={1} borderRadius={0}>
                  Clear Filters
                </Button>
                {/* {renderClearFiltersButton()} */}
              </Item>
              ...
              <Item>
                ...
                <Autocomplete
                  ...
                  getOptionLabel={(v) => v.label && v.label.length ? `${v.label}` : ''}
