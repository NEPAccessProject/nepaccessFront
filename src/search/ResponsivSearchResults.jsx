...
export default function ResponsiveSearchResults(props) {
  ...
  return (
    <>
      ...
      >
         <Typography variant='h4' paddingTop={1} paddingBottom={1} variantMapping="h2">
            Search Results
        </Typography>
        <Divider xs={{
            mb: 2,
        ...
        <Grid container>
            <Typography variant='h5' variantMapping="h3">Lake Ralph Hall Regional Water Supply Reservoir Project</Typography>
          <Grid container xs={10}>
          <Grid padding={2} flexWrap={'wrap'} container xs={12} flexDirection={'row'} flex={1} border={0}>
                <Item>
                    Status: <b>Final</b>
                </Item>
                <Item>
