...
import {Container,Grid,Typography,Box,Divider,Button,Input,InputAdornment,IconButton,TextField,FormControl,Select,ListItem} from '@mui/material';
...
export default function SearchHeader(props) {
    ...
    const {searchState,setSearchState,onKeyUp,onKeyDown,onInput} = useContext(SearchContext);
return(
