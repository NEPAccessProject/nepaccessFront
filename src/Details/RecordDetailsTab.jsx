...
import MatchSearcher from './MatchSearcher.jsx';
import MatchResults from './MatchResults.jsx';
import DetailsUpdate from './DetailsUpdate.jsx';
import DetailsFileResults from './DetailsFileResults.jsx';
import DetailsRestore from './DetailsRestore.jsx';
...
import DownloadComments from '../DownloadComments.jsx';
...
export default class RecordDetailsTab extends React.Component {
    ...
    // Receives needed props from React-Tabular instance in SearchResults.jsx
	constructor(props){
		super(props);
        this.state = {
            searcherInputs: {
