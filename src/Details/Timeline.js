...
export function showTimeline(dates, WIDTH) {
    ...
    if(dates) {
        ...
        // TODO: While preprocessing, combine any types that fall on the exact same date.
        // Text overlap is a harder problem, so generally getting rid of .stack() means accepting that possibility
